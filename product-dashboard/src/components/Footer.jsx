        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300">
              We provide a comprehensive student management system designed to streamline educational administration and enhance student success tracking.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/students" className="text-gray-300 hover:text-white transition-colors">
                  Students
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="https://github.com/Ishimwe1emma" 
